...
export const products: Product[] = [
  ...
  {
    slug: 'fbb',
    i18nKey: 'products.fbb',
    category: 'board',
    specTable: [
      { labelKey: 'specs.gsmRange', value: '200–400 gsm' },
      { labelKey: 'specs.coating', value: 'Single / Double Coated' },
      { labelKey: 'specs.brightness', value: '85–95% ISO' },
      { labelKey: 'specs.reelWidth', value: '600–2400 mm' },
      { labelKey: 'specs.coreSize', value: '76mm / 100mm' },
    ],
    applications: [
      'products.fbb.apps.luxury',
      'products.fbb.apps.pharma',
      'products.fbb.apps.cosmetics',
      'products.fbb.apps.confectionery',
    ],
    origins: ['China', 'India', 'Indonesia', 'EU'],
    typicalIndustries: [
      'products.fbb.industries.packaging',
      'products.fbb.industries.printing',
      'products.fbb.industries.luxury',
    ],
  },
];
