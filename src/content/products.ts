...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'converted',
    subtitleKey: 'products.paperConesTubes.subline',
    specsHeadingKey: 'products.paperConesTubes.headings.specs',
    applicationsHeadingKey: 'products.paperConesTubes.headings.applications',
    specTable: [
      { labelKey: 'specs.productTypes', value: 'Garnhülsen, Konushülsen, Kreuzspulhülsen, Färbehülsen', valueKey: 'specValues.productTypes.paperConesTubes' },
      { labelKey: 'specs.taper', value: '{{TODO: Konuswinkel/Taper bestätigen – z. B. 3°30′, 4°20′, 5°57′ / 1:38, 1:64}}' },
      { labelKey: 'specs.length', value: '{{TODO: Länge in mm}}' },
      { labelKey: 'specs.innerDiameter', value: '{{TODO: Innendurchmesser in mm (± Toleranz)}}' },
      { labelKey: 'specs.wallThickness', value: '{{TODO: Wandstärke in mm}}' },
      { labelKey: 'specs.surfaceFinish', value: 'glatt, gerillt, geprägt', valueKey: 'specValues.surfaceFinish.cones' },
      { labelKey: 'specs.moq', value: '{{TODO: MOQ / Mindestbestellmenge}}' },
      { labelKey: 'specs.origin', value: 'EU / Türkei', valueKey: 'specValues.origin.euTurkey' },
      { labelKey: 'specs.norm', value: '{{TODO: DIN ISO 368 – nur falls zutreffend, sonst Zeile entfernen}}' },
    ],
    applications: [
    ...
    huelseTypes: [
      { nameKey: 'products.paperConesTubes.huelseTypes.konus.name', descKey: 'products.paperConesTubes.huelseTypes.konus.desc' },
      { nameKey: 'products.paperConesTubes.huelseTypes.garn.name', descKey: 'products.paperConesTubes.huelseTypes.garn.desc' },
      { nameKey: 'products.paperConesTubes.huelseTypes.kreuzspul.name', descKey: 'products.paperConesTubes.huelseTypes.kreuzspul.desc' },
      { nameKey: 'products.paperConesTubes.huelseTypes.faerbe.name', descKey: 'products.paperConesTubes.huelseTypes.faerbe.desc' },
      { nameKey: 'products.paperConesTubes.huelseTypes.naehgarn.name', descKey: 'products.paperConesTubes.huelseTypes.naehgarn.desc' },
      { nameKey: 'products.paperConesTubes.huelseTypes.spezial.name', descKey: 'products.paperConesTubes.huelseTypes.spezial.desc' },
    ],
    comparison: {
      introKey: 'products.paperConesTubes.comparison.intro',
      pointKeys: [
        'products.paperConesTubes.comparison.points.recyclable',
        'products.paperConesTubes.comparison.points.contaminationFree',
        'products.paperConesTubes.comparison.points.dyeProcess',
        'products.paperConesTubes.comparison.points.disposal',
      ],
      sustainabilityHeadingKey: 'products.paperConesTubes.comparison.sustainabilityHeading',
      sustainabilityBodyKey: 'products.paperConesTubes.comparison.sustainabilityBody',
      sustainabilityLinkLabelKey: 'products.paperConesTubes.comparison.sustainabilityLink',
    },
    customSectionKey: 'products.paperConesTubes.custom.body',
    b2bNoteKey: 'products.paperConesTubes.b2bNote',
    heroImage: {
